...
def main():
    ...
    while True:     # Main game loop
        ...
        # Give the dealer and the player two cards from each deck:
        deck = get_deck()
...
def get_deck():
    ...
    for suit in (HEARTS, DIAMONDS, SPADES, CLUBS):
        ...
        for rank in ('J', 'Q', 'K', 'A'):
            deck.append((rank, suit))   # Add the face and the ace cards.
    random.shuffle(deck)
    return deck
...
def get_hand_value(cards):
    ...
    worth 1 or 11 (this function picks the most suitable ace value)."""
    value = 0
    number_of_aces = 0
